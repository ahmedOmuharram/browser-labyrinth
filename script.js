...
bottomBorder.hitArea = new PIXI.Rectangle(window.innerWidth/2 - 640, window.innerHeight/2 + 360 + bottomBorderY, 1300, 20);
leftBorder.hitArea = new PIXI.Rectangle(window.innerWidth/2 - 640 + leftBorderX, window.innerHeight/2 - 360, 20, 740);
rightBorder.hitArea = new PIXI.Rectangle(window.innerWidth/2 + 640 + rightBorderX, window.innerHeight/2 - 360, 20, 740);
...
const bonDragEnd = (event) => {
  event.stopPropagation();
  topBorder.parent.off("pointermove", bonDragMove);
};
...
const lonDragEnd = (event) => {
  event.stopPropagation();
  topBorder.parent.off("pointermove", lonDragMove);
};
...
const ronDragEnd = (event) => {
  event.stopPropagation();
  topBorder.parent.off("pointermove", ronDragMove);
};
...
function drawObjects(){
  ...
  bottomBorder.lineStyle(2, "#00ff00").drawRect(window.innerWidth/2 - 640, window.innerHeight/2 + 360 + bottomBorderY, 1300, 20);
  leftBorder.lineStyle(2, "#0000ff").drawRect(window.innerWidth/2 - 640 + leftBorderX, window.innerHeight/2 - 360, 20, 740);
  rightBorder.lineStyle(2, "#ff00ff").drawRect(window.innerWidth/2 + 640 + rightBorderX, window.innerHeight/2 - 360, 20, 740);
}